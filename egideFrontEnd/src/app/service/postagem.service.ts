...
export class PostagemService {
  ...
  getByIdPostagem(idPostagem: number): Observable<Postagem>{
    return this.http.get<Postagem>(`http://localhost:8080/postagem/${idPostagem}`, this.token)
  }
  ...
  deletePostagem(idPostagem: number){
    return this.http.delete(`http://localhost:8080/postagem/${idPostagem}`, this.token)
  }
